					...
					<div class="col-md-6">
						<div id="product-main-view">
							<div class="product-view">
								<img src="<?php echo base_url(); ?>assets/img/main-product01.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="<?php echo base_url(); ?>assets/img/main-product02.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="<?php echo base_url(); ?>assets/img/main-product03.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="<?php echo base_url(); ?>assets/img/main-product04.jpg" alt="">
							</div>
						</div>
						<div id="product-view">
							<div class="product-view">
							...
							<div class="product-view">
								<img src="<?php echo base_url(); ?>assets/img/thumb-product02.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="<?php echo base_url(); ?>assets/img/thumb-product03.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="<?php echo base_url(); ?>assets/img/thumb-product04.jpg" alt="">
							</div>
						</div>
					</div>
					<div class="col-md-6">
				...
				<div class="col-md-3 col-sm-6 col-xs-6">
					<div class="product product-single">
						<div class="product-thumb">
							...
							<button class="main-btn quick-view"><i class="fa fa-search-plus"></i> Quick view</button>
							<img src="<?php echo base_url(); ?>assets/img/product02.jpg" alt="">
						</div>
						<div class="product-body">
							<h3 class="product-price">$32.50 <del class="product-old-price">$45.00</del></h3>
							<div class="product-rating">
